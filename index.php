        ...
        <div class="menu__content fullheight">
          ...
          <ul class="navigation">
            <li class="light transition-el transition-el-1">
              <a id="home-trigger" href="#0">Inicio</a>
              <span>Encantada de que estés aqui</span>
            </li>
            <li class="light transition-el transition-el-2">
              <a id="about-trigger" class="inner-link" href="#0">Información</a>
              <span>Toda la Información</span>
            </li>
            <li class="light transition-el transition-el-3">
              <a id="works-trigger" class="inner-link" href="#0">Proximamente...</a>
              <span>Proximamente...</span>
            </li>
            <!-- <li class="light transition-el transition-el-4">
              <a id="contact-trigger" class="inner-link" href="#0">No sé</a>
              <span>Hola</span>
            </li> -->
          </ul>
          <!-- Menu List End -->
              ...
              <div class="row gx-0">
                <div class="col-12 col-xl-6 text-align-left">
                  <ul class="socials-text light">
                    <li>
                      <a href="https://www.facebook.com/ElMesiasDeMerida" target="_blank">Fb</a>
                    </li>
                    <li>
                      <a href="https://www.youtube.com/@IBEMYucatan" target="_blank">Yt</a>
                    </li>
                  </ul>
                </div>
          ...
          <div class="col-12 col-xl-6 main__media">
            ...
            <div class="mainmedia__container">
              <div class="mainmedia__content">
                ...
                <div class="mainmedia__image main-image-c1-3"></div>
                ...
                <!-- Section Color Layer Start -->
                <div class="color-layer color-layer-medium"></div>
                <!-- Section Color Layer End -->

                <!-- Countdown Start -->
                <div class="countdown countdown-days light">
                  <div id="countdown"></div>
                  <span class="help-text">días para el campamento</span>
                </div>
                <!-- Countdown End -->
