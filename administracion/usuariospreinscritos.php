        ...
        <div class="content-body">
            ...
            <?php
                try {
                    ...
                    $sql = "SELECT *, YEAR(CURDATE()) - YEAR(fechaNacimiento) AS edad FROM usuariopreinscritos";
                                ...
                                <table class="table table-vertical-middle">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><?php echo $usuarios['fechaNacimiento']?></td>
                                            <td><?php echo $usuarios['edad']?></td>
                                            <td><?php echo $usuarios['iglesiaPerteneciente']?></td>
